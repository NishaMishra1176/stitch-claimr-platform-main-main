...
<header>
  <div class="logo">
    <a href="./index.html">AmazonReconciliation</a>
  </div>
  <nav>
    <div class="dropdown">
      <a href="./amazonreconciliation_homepage_-_panic_interceptor_1/code.html">What Happened? <span>▼</span></a>
      <!-- Dropdown menu with problem types -->
    </div>
    <div class="dropdown">
      <a href="./amazonreconciliation_home_-_forensic_engine_variant_2/code.html">Fix My Order <span>▼</span></a>
  ...
  <div class="cta">
    <a href="./amazonreconciliation_home_-_financial_triage_variant_1_1/code.html">Escalate Now</a>
  </div>
</header>
```
...
<footer>
  <div class="company-info">
    <h4>AmazonReconciliation</h4>
    <p>Fighting courier fraud with legal precision. Based in Indore, India</p>
  </div>
  <div class="stage-navigation">
    <h4>Stage 0: Entry</h4>
    <ul>
      <li><a href="./index.html">Merged Homepage</a></li>
      <li><a href="./amazonreconciliation_homepage_-_panic_interceptor_1/code.html">Panic Interceptor</a></li>
      ...
    </ul>
  </div>
  <div class="stage-navigation">
    ...
    <ul>
      ...
      <li><a href="./amazonreconciliation_home_-_forensic_engine_variant_2/code.html">Forensic Engine</a></li>
      ...
    </ul>
  </div>
  <div class="stage-navigation">
    ...
    <ul>
      ...
      <li><a href="./amazonreconciliation_home_-_escalation_engine_variant_1/code.html">Escalation Engine</a></li>
      ...
    </ul>
  </div>
  <div class="stage-navigation">
    ...
    <ul>
      <li><a href="./amazonreconciliation_recovery_dashboard_ui/code.html">Recovery Dashboard</a></li>
  ...
  <div class="global-navigation">
    ...
    <ul>
      ...
      <li><a href="./amazonreconciliation_home_-_escalation_engine_variant_1/code.html">Legal</a></li>
...
|---------------|---------------------|------------------|-------------|-------------------|
| **STAGE A: ENTRY / PANIC** |
| index.html | Home | Stage A | Escalate Now | amazonreconciliation_home_-_financial_triage_variant_1_1/code.html |
| amazonreconciliation_homepage_-_panic_interceptor_1/code.html | What Happened? | Stage A | Identify My Case | amazonreconciliation_home_-_financial_triage_variant_1_1/code.html |
| amazonreconciliation_homepage_-_panic_interceptor_2/code.html | What Happened? | Stage A | Escalate Now | amazonreconciliation_home_-_forensic_engine_variant_2/code.html |
| amazonreconciliation_homepage_-_panic_interceptor_3/code.html | What Happened? | Stage A | Check My Risk | seller_recovery_management_dashboard/code.html |
| amazonreconciliation_homepage_-_panic_interceptor_4/code.html | What Happened? | Stage A | Start Recovery | amazonreconciliation_home_-_escalation_engine_variant_1/code.html |
| amazonreconciliation_home_-_panic-to-proof_variant_1/code.html | What Happened? | Stage A | Start Recovery | amazonreconciliation_home_-_financial_triage_variant_1_1/code.html |
| amazonreconciliation_home_-_authoritative_entry_variant_1/code.html | Home | Stage A | Escalate Now | amazonreconciliation_home_-_forensic_engine_variant_2/code.html |
| **STAGE B: SITUATION CLASSIFICATION** |
| amazonreconciliation_home_-_financial_triage_variant_1_1/code.html | Fix My Order | Stage B | Identify Issue | amazonreconciliation_home_-_forensic_engine_variant_2/code.html |
| amazonreconciliation_home_-_financial_triage_variant_1_2/code.html | Fix My Order | Stage B | Identify Issue | fake_rto_forensic_checker_1/code.html |
| crisis_lifecycle_master_index/code.html | Fix My Order | Stage B | Analyze Case | amazonreconciliation_home_-_forensic_engine_variant_2/code.html |
| audience_segmentation_entry_ui_variant_1/code.html | Fix My Order | Stage B | Get Started | amazonreconciliation_home_-_financial_triage_variant_1_1/code.html |
| who_this_is_for_-_client_filtering_page/code.html | Home | Stage B | Continue | amazonreconciliation_homepage_-_panic_interceptor_1/code.html |
| process_experience_map_variant_3/code.html | Fix My Order | Stage B | Start Recovery | amazonreconciliation_home_-_escalation_engine_variant_1/code.html |
...
| amazonreconciliation_home_-_forensic_engine_variant_2/code.html | Fix My Order | Stage C | Generate Evidence | sla_evidence_engine_variant_2/code.html |
...
| fake_attempt_geo-validator_variant_2_1/code.html | Fix My Order | Stage C | Validate Location | amazonreconciliation_home_-_forensic_engine_variant_2/code.html |
| fake_attempt_geo-validator_variant_2_2/code.html | Fix My Order | Stage C | Validate Location | amazonreconciliation_home_-_forensic_engine_variant_2/code.html |
...
| evidence-to-closure_gallery_variant_3/code.html | Evidence | Stage D | View Evidence | amazonreconciliation_home_-_escalation_engine_variant_1/code.html |
...
| amazonreconciliation_home_-_escalation_engine_variant_1/code.html | Legal | Stage E | Escalate Now | legal_notice_generator_1/code.html |
| interactive_escalation_reply_tool_variant_2/code.html | Legal | Stage E | Reply Now | amazonreconciliation_home_-_escalation_engine_variant_1/code.html |
...
| nodal_officer_email_directory/code.html | Legal | Stage E | Contact Officer | amazonreconciliation_home_-_escalation_engine_variant_1/code.html |
...
| asset_recovery_hub_variant_3/code.html | Recovery | Stage F | Recover Assets | amazonreconciliation_recovery_dashboard_ui/code.html |
| amazonreconciliation_recovery_dashboard_ui/code.html | Recovery | Stage F | Track Recovery | visual_profit_recovery_experience/code.html |
...
└─────────────────────────┘
         ...
         ▼
┌─────────────────────────┐
│  amazonreconciliation_homepage_-_    │
│  panic_interceptor_1/   │
│  code.html             │
│ (Panic Interception)    │
└─────────────────────────┘
